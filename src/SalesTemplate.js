    ...
    <>
      <div className="invoice-container" ref={componentRef}>
        ...
        <div className="invoice-info">
          ...
          <div className="invoice-details">
            ...
            <p>
              Transaction Date :
              {new Date(headerData[0].bill_date).toLocaleDateString()}{" "}
            </p>
            <p>Sales Type :{headerData[0].sales_type} </p>
        ...
        <div className="invoice-summary">
          ...
          <p className="invoice-amount-words">
            ...
            <span className="amount-in-words">{totalAmountInWords}</span>
          </p>
      ...
      >
        <div align="left" class="d-flex justify-content-start">
          ...
          <button type="button" onClick={handlePrint} className="PrintButton">
