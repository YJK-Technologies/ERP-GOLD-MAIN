...
function Input({}) {
      ...
      async () => {
        try {
          const response = await fetch(
            `${config.apiBaseUrl}/deleteEmployeeLoan`,
            {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
  ...
  const onCellValueChanged = (params) => {
    ...
    const rowIndex = updatedRowData.findIndex(
      (row) =>
        row.Employee_Salary === params.data.Employee_Salary &&
        row.Taxable_Amount === params.data.Taxable_Amount &&
        row.Start_Year === params.data.Start_Year &&
        row.End_Year === params.data.End_Year,
    );
    if (rowIndex !== -1) {
                    ...
                    <div className="exp-form-floating">
                      <div className="d-flex justify-content-start">
                        <div>
                          <label
                            htmlFor="EmployeeId"
                            className={`${error && !EmployeeId ? "red" : ""}`}
                          >
                            {" "}
                            Employee ID{" "}
                            {showAsterisk && (
                      ...
                      <div class="exp-form-floating">
                        <div class="d-flex justify-content-start">
                          <div>
                            <label
                              for="sname"
                              className={`${error && !ApprovedBy ? "red" : ""}`}
                            >
                              Approved By
                              {showAsterisk && (
                                <span className="text-danger">*</span>
                    ...
                    <div class="exp-form-floating">
                      <div class="d-flex justify-content-start">
                        <div>
                          ...
                          <label
                            for="add1"
                            className={`${error && !LoanEligibleAmount ? "red" : ""}`}
                          >
                            {" "}
                      ...
                      <input
                        ...
                        placeholder=""
                        required
                        title="Please enter the Eligible Amount"
                        value={LoanEligibleAmount}
                        onChange={(e) =>
                          setLoanEligibleAmount(e.target.value.slice(0, 7))
                        }
                        maxLength={30}
                      />
                    ...
                    <div class="exp-form-floating">
                      <div class="d-flex justify-content-start">
                        <div>
                          ...
                          <label
                            for="add2"
                            className={`${error && !EffectiveDate ? "red" : ""}`}
                          >
                            {" "}
                            Effective Date{" "}
                            {showAsterisk && (
                      ...
                      <input
                        ...
                        placeholder=""
                        required
                        title="Please enter the Effective Date"
                        value={EffectiveDate}
                  ...
                  <div className="col-md-3 form-group mb-2">
                    <div class="exp-form-floating">
                      ...
                      <input
                        ...
                        value={HowManyMonth}
                        onChange={(e) =>
                          setHowManyMonth(e.target.value.slice(0, 2))
                        }
                        max={5}
                      />
                  ...
                  <div className="col-md-3 form-group mb-2">
                    <div class="exp-form-floating">
                      ...
                      <input
                        ...
                        placeholder=""
                        required
                        title="Please Enter the EMI Amount"
                        value={EMIAmount}
                        onChange={(e) =>
                          setEMIAmount(e.target.value.slice(0, 6))
                        }
                        maxLength={60}
                      />
                    </div>
                      ...
                      <div class="exp-form-floating">
                        ...
                        <div class="d-flex justify-content-start">
                          <input
                            ...
                            value={Loaneligibleamount}
                            onChange={(e) =>
                              setloanEligibleamount(e.target.value)
                            }
                            onKeyDown={(e) =>
                              e.key === "Enter" && handleSearch()
                            }
