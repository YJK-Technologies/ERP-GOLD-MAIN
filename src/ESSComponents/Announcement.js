...
function Input({}) {
  ...
  const [msgtypedrop, setmsgtypedrop] = useState("");
  const [RequestfordoNotShowAgainOption, setRequestfordoNotShowAgainOption] =
    useState("");
  ...
  const [MessageTitle, setmessageTitle] = useState("");
  const [selectedAnnouncementvalid, setselectedAnnouncementvalid] =
    useState("");
  ...
  const handleSearch = async () => {
    try {
      const response = await fetch(
        `${config.apiBaseUrl}/AnnouncementSearchCretria`,
        {
          method: "POST",
          headers: {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${config.apiBaseUrl}/addAnnounmentdetails`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      if (response.status === 200) {
        ...
        const errorResponse = await response.json();
        toast.warning(
          errorResponse.message || "Failed to insert announcement data",
        );
  ...
  const deleteSelectedRows = async (rowData) => {
    ...
    showConfirmationToast(
      ...
      async () => {
        try {
          const response = await fetch(
            `${config.apiBaseUrl}/deleteAnnouncement`,
            {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
  ...
  const handleAnnouncement = (selectedAnnouncement) => {
    ...
    setAnnouncementValidfor(
      selectedAnnouncement ? selectedAnnouncement.value : "",
    );
  };
                  ...
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label
                          for="cname"
                          className={`${error && !Announcementid ? "red" : ""}`}
                        >
                          {" "}
                          Announcement ID{" "}
                          {showAsterisk && (
                    ...
                    <input
                      ...
                      placeholder=""
                      required
                      title="Please enter the Announcement ID "
                  ...
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label
                          for="sname"
                          className={`${error && !SelectType ? "red" : ""}`}
                        >
                          Select Type{" "}
                          {showAsterisk && (
                            <span className="text-danger">*</span>
                  ...
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        ...
                        <label
                          for="add1"
                          className={`${error && !selectDetails ? "red" : ""}`}
                        >
                          {" "}
                          Select Details{" "}
                          {showAsterisk && (
                  ...
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        ...
                        <label
                          for="add1"
                          className={`${error && !selectedAnnouncement ? "red" : ""}`}
                        >
                          {" "}
                    ...
                    <Select
                      ...
                      class="exp-input-field form-control"
                      required
                      title="Please Select the Announcement Duration"
                      ...
                      <div class="exp-form-floating">
                        <div class="d-flex justify-content-start">
                          <div>
                            ...
                            <label
                              for="add1"
                              className={`${error && !Start_Time ? "red" : ""}`}
                            >
                              {" "}
                              Start Time{" "}
                              {showAsterisk && (
                  ...
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label
                          for="add1"
                          className={`${error && !selectedMessageType ? "red" : ""}`}
                        >
                          {" "}
                          Message Type{" "}
                          {showAsterisk && (
                  ...
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        ...
                        <label
                          for="add1"
                          className={`${error && !messagetitle ? "red" : ""}`}
                        >
                          {" "}
                          Message Title{" "}
                          {showAsterisk && (
                  ...
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label
                          for="add1"
                          className={`${error && !selectedStatus ? "red" : ""}`}
                        >
                          Status{" "}
                          {showAsterisk && (
                            <span className="text-danger">*</span>
