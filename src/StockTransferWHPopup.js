...
export default function StockTransferWarehousePopup({
  open,
  handleClose,
  handleWarehouse,
}) {
        ...
        <fieldset>
          <div>
            <div className="purbut">
              ...
              <div
                className="modal mt-5 Topnav-screen popupadj popup"
                tabIndex="-1"
                role="dialog"
                        ...
                        <div className="row me-3 ms-3">
                          <div className="col-sm mb-2">
                            <input
                              ...
                              onChange={(e) =>
                                setwarehouse_code(e.target.value)
                              }
                              onKeyDown={(e) =>
                                e.key === "Enter" && handlewarehouseSearch()
                              }
                              autoComplete="off"
                            />
                          </div>
