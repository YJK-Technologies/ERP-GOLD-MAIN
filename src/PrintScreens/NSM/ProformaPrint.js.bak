        ...
        <div>
            <div className="InvoiceContainer custom-text topnav-screen">
                <div className="d-flex justify-content-between align-items-center border border-bottom-0 mb-0 border-1 border-dark text-dark px-3">
                    <h2 className="text-center w-100 fs-5 ms-5 m-0">PROFORMA INVOICE</h2>
                                ...
                                <tr>
                                    ...
                                    <td colSpan="2" className="border border-dark">
                                        <tr className="small-row border-bottom border-dark">
                                            <td className="p-1 border-dark"><strong>Proforma No:</strong>
                                        ...
                                        <tr className="small-row border-bottom border-dark">
                                            <td className="p-1"><strong>Notes:</strong>
                                                <br /> -
                                            </td>
                                        </tr>
                ...
                <p className="mt-1"><strong>Dear Sir,</strong><br />We are pleased to confirm your order for the following product as per terms and conditions mentioned below.</p>
