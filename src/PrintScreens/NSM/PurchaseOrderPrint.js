...
const Invoice = () => {
  ...
  const taxAmountFormatted = taxAmount.toLocaleString("en-IN", {
    minimumFractionDigits: 2,
    maximumFractionDigits: 2,
  });
  const purchaseAmountFormatted = purchaseAmount.toLocaleString("en-IN", {
    minimumFractionDigits: 2,
    maximumFractionDigits: 2,
  });
    ...
    <div>
      <div className="InvoiceContainer custom-text topnav-screen">
                ...
                <tr>
                  <td colSpan="2" className="border border-dark">
                    ...
                    <div className="mt-3 p-1">
                      ...
                      {[
                        ...
                        .join(", ")}
                      <br />
                      <strong>GST No:</strong> {detailData[0].vendor_gst_no}
                      <br />
                      <strong>State:</strong>
                      {detailData[0].state}
                      <br />
                  ...
                  <td colSpan="2" className="border border-dark">
                    <tr className="large-row border-bottom border-dark">
                      <td className="p-1 border-end border-dark">
                        <strong>PO No:</strong>
                        <br />
                    ...
                    <tr className="large-row border-bottom border-dark">
                      <td className="p-1">
                        <strong>Date:</strong>
                        <br />
                        {formatDate(headerData[0].Entry_date)}
                      </td>
                    </tr>
                    <tr className="large-row border-bottom border-dark">
                      <td className="p-1">
                        ...
                        <br />
                        {formatDate(headerData[0].delivery_date)}
                      </td>
                    </tr>
              ...
              <tr className="">
                ...
                <td style={{ paddingLeft: "10px" }}>
                  {new Intl.NumberFormat("en-IN", {
                    style: "currency",
                    currency: "INR",
                  }).format(headerData[0].purchase_amount)}
                </td>
              </tr>
              {taxData.map((row, index) => (
                <tr key={index} className="">
                  <td style={{ textAlign: "right" }}>
                    <strong>{row.tax_name_details || "-"}%</strong>
                  </td>
                  <td>
                    {new Intl.NumberFormat("en-IN", {
                      style: "currency",
                      currency: "INR",
                    }).format(row.tax_amt || 0)}
                  </td>
                </tr>
              ))}
              <tr>
                ...
                <td>
                  {new Intl.NumberFormat("en-IN", {
                    style: "currency",
                    currency: "INR",
                  }).format(parseFloat(headerData[0].total_amount))}
                </td>
              </tr>
            </thead>
          </table>
        ...
        <section className="text-amount mt-2">
          <p className="amount-in-words1">
            Grand Total In Words:
            <strong>
              <span className="invoice-amount-words1">
                {totalAmountInWords}
              </span>
            </strong>
          </p>
