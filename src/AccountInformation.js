...
const AccountInformation = () => {
  ...
  const UserPermission = async () => {
    try {
      const response = await fetch(`${config.apiBaseUrl}/getUserPermission`, {
        ...
        body: JSON.stringify({ company_code: sessionStorage.getItem('selectedCompanyCode'), user_code: sessionStorage.getItem('user_code') }),
      });
  ...
  const handleSave = async (data) => {
    ...
    sessionStorage.setItem('selectedRoleID', data.role_id);
