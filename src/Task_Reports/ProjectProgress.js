...
const MyAgGridComponent = () => {
  ...
  const handleCellClick = async (params) => {
    ...
    try {
      ...
      const response = await fetch(
        `${config.apiBaseUrl}/getProjectDetailReport`,
        {
          method: "POST",
  ...
  const handleNavigateWithRowData = (selectedRowS) => {
    ...
    navigate("/ProjectDetails", {
      state: {
        TaskMasterID: selectedRowS.TaskMasterID,
  ...
  const handleExportToExcel = () => {
    ...
    const headerData = [["Project Progress"]];
        ...
        <div class="">
          ...
          <div className=" p-0 shadow-lg bg-white rounded mb-2">
            <div className="purbut mb-0 d-flex justify-content-between">
              <h1 align="left" className="ms-4">
                Project Progress
              </h1>
              <div className="purbut">
                <div className="d-flex justify-content-end me-5">
                  <button
                    className="btn btn-dark mt-2 mb-1 rounded-3"
              ...
              <div className="col-md-3 form-group mb-2">
                <div class="exp-form-floating">
                  <div class="d-flex justify-content-start">
                    <label
                      htmlFor="EmployeeId"
                      className={`${error && !ProjectName ? "red" : ""}`}
                    >
                      Project Name
                    </label>
                    <div>
                ...
                <div class="exp-form-floating">
                  <div class="d-flex justify-content-start">
                    <div>
                      ...
                      <label
                        for="add1"
                        className={`${error && !ProjectManager ? "red" : ""}`}
                      >
                        Project Manager
                      </label>
                    </div>
                ...
                <div class="exp-form-floating">
                  <div class="d-flex justify-content-start">
                    <div>
                      ...
                      <label
                        for="tcode"
                        className={`${error && !PriorityLevel ? "red" : ""}`}
                      >
                        Priority Level{" "}
                      </label>
                    </div>
