...
import { Printer } from "lucide-react"; // or from "react-feather"
import {
  Building,
  Briefcase,
  BuildingFill,
          ...
          <Link to="/Dashboard" class="nav-link" title="Dashboard">
            <div class="menu-item">
              <svg
                ...
                height="18"
                fill="currentColor"
                class="bi bi-speedometer me-2 Dash-font"
                viewBox="0 0 16 16"
              >
        ...
        <div className={`collapse ${adminCollapsed ? "show" : "hide"}`} >
          ...
          <div className=" ms-3">
            {screenType.includes("ValidationGrid") && (
              <Link to="/ValidationGrid" className="nav-link" title="Validation Grid">
                <div class="menu-item">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
  ...
  {screenType.includes("TemplateDesign") && (
    <Link to="/TemplateDesign" className="nav-link" title="PrintTemplate">
      <div className="menu-item">
        ...
        <div className={`collapse ${TransactionsCollapsed ? "show" : ""}`}>
          <div className=" ms-3">
            {screenType.includes("Adjustment") && (
              <Link to="/Adjustment" className="nav-link" title="Adjustment">
                <div class="menu-item">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
          ...
          <div className=" ms-3">
            {screenType.includes("AssetsReturn") && (
              <Link
                to="/AssetsReturn"
                className="nav-link"
                title="Assets Allocation Return"
                onClick={() => handleLinkClick("AssetsReturn")}
              >
                <div class="menu-item">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className=" ms-3">
            {screenType.includes("DeliveryChallan") && (
              <Link to="/DeliveryChallan" className="nav-link" title="Delivery Challan">
                <div class="menu-item">
                  <svg
                    viewBox="0 0 128 128"
                    width="18"
          ...
          <div className={`collapse ${unplannedCollapsed ? "show" : ""}`}>
            <div className=" ms-3">
              {screenType.includes("UnplannedIssued") && (
                <Link to="/UnplannedIssued" className="nav-link" title="Inventory Issue">
                  <div class="menu-item">
                    <svg
                      class="svg-icon me-3"
            ...
            <div className=" ms-3">
              {screenType.includes("UnplannedReceipt") && (
                <Link to="/UnplannedReceipt" className="nav-link" title="Inventory Receipt">
                  <div class="menu-item">
                    <svg
                      class="svg-icon me-3"
                      viewBox="0 0 1024 1024"
            ...
            <div className=" ms-3">
              {screenType.includes("UnplannedReturn") && (
                <Link to="/UnplannedReturn" className="nav-link" title="Inventory Return">
                  <div class="menu-item">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
          ...
          <div className=" ms-3">
            {screenType.includes("OpeningItem") && (
              <Link to="/OpeningItem" className="nav-link" title="Opening Item">
                <div class="menu-item">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
          ...
          <div className="menu-item" onClick={togglePurchaseCollapse} title="Purchase">
            ...
            <div class="purchase-arrow">
              {purchaseCollapsed ? <BsChevronDown /> : <BsChevronRight />}
            </div>
          </div>
          <div className={`collapse ${purchaseCollapsed ? "show" : ""}`}>
            <div className=" ms-3">
            ...
            <div className=" ms-3">
              {screenType.includes("PurchaseOrder") && (
                <Link to="/PurchaseOrder" className="nav-link" title="Purchase Order">
                  <div class="menu-item">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
            ...
            <div className=" ms-3">
              {screenType.includes("PurchaseReturn") && (
                <Link to="/PurchaseReturn" className="nav-link" title="Purchase Return">
                  <div class="menu-item">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
          ...
          <div className=" ms-3">
            {screenType.includes("PendingCustomer") && (
              <Link to="/PendingCustomer" className="nav-link" title="Pending Customer">
                <div class="menu-item">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
          ...
          <div className=" ms-3">
            {screenType.includes("ReceivedGoods") && (
              <Link to="/ReceivedGoods" className="nav-link" title="Received Goods">
                <div class="menu-item">
                  <svg
                    width="18"
                    height="18"
          ...
          <div className={`collapse ${salesCollapsed ? "show" : ""}`}>
            ...
            <div className=" ms-3">
              {screenType.includes("SalesReturn") && (
                <Link to="/SalesReturn" className="nav-link" title="Sales Return">
                  {" "}
                  <div class="menu-item">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <div className=" ms-3">
            {screenType.includes("Stocktransfer") && (
              <Link to="/Stocktransfer" className="nav-link" title="Stock Transfer">
                <div class="menu-item">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
        ...
        <div className="menu-item" onClick={toggleReportCollapse} title="Report">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
        ...
        <div className={`collapse ${reportCollapsed ? "show" : ""}`}>
          <div className="ms-3">
            {screenType.includes("DCanalysis") && (
              <Link to="/DCanalysis" className="nav-link" title="Delivery Challan Analysis">
                <div class="menu-item">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
          ...
          <div className=" ms-3">
            {screenType.includes("POanalysis") && (
              <Link to="/POanalysis" className="nav-link" title="Purchase Order Analysis">
                <div class="menu-item">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
          ...
          <div className="ms-3">
            {screenType.includes("QOanalysis") && (
              <Link to="/QOanalysis" className="nav-link" title="Quotation Analysis">
                <div class="menu-item">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
          ...
          <div className="ms-3">
            {screenType.includes("TIanalysis") && (
              <Link to="/TIanalysis" className="nav-link" title="Invoice Analysis">
                <div class="menu-item">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
              ...
              <Link to="/GSTReport" className="nav-link" title="GST Report">
                <div class="menu-item">
                  <svg
                    ...
                    class="me-3"
                  >
                    <rect x="8" y="8" width="48" height="56" rx="4" fill="white" />
                    <path d="M40 8h16v16H40z" fill="white" stroke="black" />
                    <line x1="16" y1="28" x2="48" y2="28" />
                    <rect x="20" y="38" width="6" height="12" fill="white" />
                    <rect x="30" y="34" width="6" height="16" fill="white" />
          ...
          <div className="ms-3">
            {screenType.includes("ReceivedGoodsRt") && (
              <Link to="/ReceivedGoodsRt" className="nav-link" title="GST Report">
                <div class="menu-item">
                  <svg
                    width="18"
                    height="18"
                    ...
                    class="me-3"
                  >
                    <rect x="8" y="8" width="48" height="48" rx="4" stroke="white" stroke-width="2" />
                    <path
                      ...
                      stroke-linejoin="round"
                    />
                    <circle cx="48" cy="48" r="8" stroke="black" stroke-width="2" />
                    <path
          ...
          <div className="ms-3">
            {screenType.includes("OIAnalysis") && (
              <Link to="/OIAnalysis" className="nav-link" title="Opening Item Analysis">
                <div class="menu-item">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 64 64"
                  ...
                  >
                    ...
                    <path d="M16 24h12l4-4h16v28H16z" fill="none" stroke="white" />
        ...
        <div className="menu-item" onClick={toggleESSCollapse} title="ESS">
          ...
          <span className={collapsed ? "hidden" : ""}>ESS</span>
          <div class="ESS-arrow">
          ...
          <div className="CRM-arrow ms-5 ps-5">
           ...
           <div className="menu-item ms-3 mt-3">
              ...
              <Link to="/CRMSettings" className="nav-link" title="Warehouse">
                <div class="">
                  <BuildingFill size={18} className="me-3" />
                  <span className={collapsed ? "show" : ""}>  Settings </span>
                </div>
              </Link>
            )}
          </div>
